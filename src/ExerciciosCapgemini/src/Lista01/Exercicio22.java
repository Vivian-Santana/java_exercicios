...
public class Exercicio22 {
	...
	public static void main(String[] args) {
		...
		String produto = null;
		float precoCusto = 0, precoVenda = 0, totalCusto = 0, totalVenda = 0;

		int i = 0; // VARIÁVEL Q É CONTROLE DO FOR TEM QUE ESTAR FORA DO () PARA VALER DENTRO DO
					// MÉTODO INTEIRO NÃO APENAS DENTRO DO FOR.
		for (; i < 40; i++) {
